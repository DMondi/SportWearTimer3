 ...
 */
public class ConfigureRepeatActivityMobile extends Activity {
    ...
    class onOkClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            data.putExtra("repeatCount", ConfigureRepeatActivityMobile.this.repeatCount);
            ConfigureRepeatActivityMobile.this.setResult(-1, data);
            ConfigureRepeatActivityMobile.this.finish();
        }
    }
    ...
    private class RepeatCountModifier implements View.OnClickListener {
        ...
        public void onClick(View v) {
            long theValue = ConfigureRepeatActivityMobile.this.repeatCount;
            if (this.add) {
                theValue++;
            ...
            ConfigureRepeatActivityMobile.this.repeatCount = theValue;
            ConfigureRepeatActivityMobile.this.updateTimerParts();
        }
    }
